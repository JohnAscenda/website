...
minimum. But if you would like to see that, make sure to share the article. This
is something I cover in-depth in my course, but it requires a quite large blog
post! For something free, I made a personal project open-source that implements
